#!/usr/bin/env python3
"""
Запуск универсального веб-интерфейса для FAN моделей
"""
...
def main():
    ...
    print("🚀 Запуск универсального FAN интерфейса...")
    print("=" * 50)
    ...
    # Запускаем интерфейс
    interface_path = os.path.join(os.path.dirname(__file__), "demos", "universal_web_interface.py")
